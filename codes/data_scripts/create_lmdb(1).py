...
def main():
    ...
    if dataset == 'vimeo90k':
        ...
        opt = {}
        # ## GT
        # opt['img_folder'] = r'C:\Users\Administrator\Desktop\research\data\Urban\GT'
        # opt['lmdb_save_path'] = r'C:\Users\Administrator\Desktop\research\data\Urban\lmdb\GT.lmdb'
        # opt['name'] = 'DIV2K_GT'
        # general_image_folder(opt)
        # ## LR
        # opt['img_folder'] = r'C:\Users\Administrator\Desktop\research\data\Urban\LR'
        # opt['lmdb_save_path'] = r'C:\Users\Administrator\Desktop\research\data\Urban\lmdb\LR.lmdb'
        # opt['name'] = 'DIV2K_LR'
        # general_image_folder(opt)
        ## HR
        opt['img_folder'] = r'C:\Users\Administrator\Desktop\research\data\Urban\HRx2'
        opt['lmdb_save_path'] = r'C:\Users\Administrator\Desktop\research\data\Urban\lmdb\HRx2.lmdb'
        opt['name'] = 'DIV2K_HR'
        general_image_folder(opt)
    elif dataset == 'test':
