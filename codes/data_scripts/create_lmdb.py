...
def main():
    ...
    if dataset == 'vimeo90k':
        ...
        opt = {}
        # # GT
        opt['img_folder'] = '/media/omnisky/ubuntu/zxz/obj_data/DIV2K/just_test/GT'
        opt['lmdb_save_path'] = '/media/omnisky/ubuntu/zxz/obj_data/DIV2K/just_test/lmdb/GT.lmdb'
        opt['name'] = 'DIV2K_GT'
        general_image_folder(opt)
        # LR
        opt['img_folder'] = '/media/omnisky/ubuntu/zxz/obj_data/DIV2K/just_test/LR'
        opt['lmdb_save_path'] = '/media/omnisky/ubuntu/zxz/obj_data/DIV2K/just_test/lmdb/LR.lmdb'
        opt['name'] = 'DIV2K_LR'
        general_image_folder(opt)
        # # LR
        # opt['img_folder'] = '/media/omnisky/ubuntu/zxz/newdata/Urban/GC'
        # opt['lmdb_save_path'] = '/media/omnisky/ubuntu/zxz/newdata/Urban/lmdb/GC.lmdb'
        # opt['name'] = 'DIV2K_LR'
        # general_image_folder(opt)
        ## HR
        opt['img_folder'] = '/media/omnisky/ubuntu/zxz/obj_data/DIV2K/just_test/HR'
        opt['lmdb_save_path'] = '/media/omnisky/ubuntu/zxz/obj_data/DIV2K/just_test/lmdb/HR.lmdb'
        opt['name'] = 'DIV2K_HR'
        # general_image_folder(opt)
        # HRx2
        # opt['img_folder'] = '/media/omnisky/ubuntu/zxz/obj_data/DIV2K/obj_all/HRx2'
        # opt['lmdb_save_path'] = '/media/omnisky/ubuntu/zxz/obj_data/DIV2K/obj_all/lmdb/HRx2.lmdb'
        # opt['name'] = 'DIV2K_HRx2'
        general_image_folder(opt)
    elif dataset == 'test':
