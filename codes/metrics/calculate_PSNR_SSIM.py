...
def main():
    ...
    folder_GT = r'/media/omnisky/7D37935326D33C41/zxz/model/mmsr/val/obj/20200917_2/DIV2K100x2/G2/'
    folder_Gen = r'/media/omnisky/ubuntu/zxz/obj_data/obj/HRx2/'
    # / media / omnisky / ubuntu / zxz / newdata / DIV2K / train / GT
    crop_border = 2
    ...
    for i, img_path in enumerate(img_list):
        ...
        cropped_Gen, cropped_GT = util.crop_border([im_Gen_in[:, :, 0], im_GT_in[:, :, 0]], 0)

        # calculate PSNR and SSIM
        # PSNR = calculate_psnr(cropped_GT * 255, cropped_Gen * 255)
        #
        # SSIM = calculate_ssim(cropped_GT * 255, cropped_Gen * 255)
        g2_psnr = util.calculate_psnr(cropped_Gen*255, cropped_GT*255)
        g2_ssim = util.calculate_ssim(cropped_Gen*255, cropped_GT*255)
